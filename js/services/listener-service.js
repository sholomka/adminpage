    ...
    module.factory("$listenerService", ["$sessionStorage","$configService", function($sessionStorage,$configService) {
    	...
    	var getDefaultRegion=function() {
			return {
				...
				coords:
					[[51.37879034979395, 12.405678749084473],
					[51.37879034979395, 12.417695045471191],
					[51.371155583093426, 12.417695045471191],
					[51.371155583093426, 12.405678749084473]]

						// [[51.450189013791665,12.073658093359427],
